      ...
      return function () {
         ...
         var dfh = function (_v4) {
            return function () {
               switch (_v4.ctor)
               {case "_Tuple2":
                  return $Rebase.decFromHex(A3($String.slice,
                    _v4._0,
                    _v4._1,
                    str));}
               _U.badCase($moduleName,
               "on line 91, column 21 to 55");
            }();
         };
         var _ = A2($List.map,
         dfh,
         ...
         {case "_Tuple2":
            return function () {
                 ...
                 var txtTiny = function ($) {
                    return $Graphics$Element.centered($Text.height(12)($Text.typeface(_L.fromArray(["BentonSansRegular"
                                                                                                   ,"sans"]))($Text.fromString($))));
                 };
                 var txtFn = function ($) {
                    return $Graphics$Element.centered($Text.height(26)($Text.typeface(_L.fromArray(["BentonSansRegular"
                                                                                                   ,"sans"]))($Text.fromString($))));
                 };
...
Elm.Rebase.make = function (_elm) {
   ...
   var decFromHex = function (hexString) {
      return function () {
