         ...
         {case "_Tuple2":
            return function () {
                 ...
                 var cols = _L.fromArray([columnAlpha
                                         ,columnHue]);
                 var boxed = function (_v41) {
                    return function () {
                       switch (_v41.ctor)
                       {case "_Tuple2":
                          return function () {
                               var rc = $Color.toRgb(_v41._1);
                               var rc$ = A3($Color.rgb,
                               rc.red,
                               rc.green,
                               rc.blue);
                               var hc = $Color.toHsl(_v41._1);
                               var hc$ = A3($Color.hsl,
                               hc.hue,
                               hc.saturation,
                               hc.lightness);
                               var mw = _v33._0 / $List.length(cols) | 0;
                 ...
                 var titleStyle = $Text.style({_: {}
                                              ...
                                              ,typeface: _L.fromArray(["BentonSansBold"
                                                                      ,"sans"])});
                 var title = function ($) {
                    return $Graphics$Element.width(_v33._0)($Text.centered(titleStyle($Text.fromString($))));
